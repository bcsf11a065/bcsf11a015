...
(function () {
    ...
    function calculateEditDistanceMatrix(oldArray, newArray, maxAllowedDistance) {
        ...
        var distanceViaAddition, distanceVadeletion;
    ...
    function findEditScriptFromEditDistanceMatrix(editDistanceMatrix, oldArray, newArray) {
        ...
        while ((oldIndex > 0) || (newIndex > 0)) {
            ...
            var distanceVadelete = (oldIndex > 0) ? editDistanceMatrix[newIndex][oldIndex - 1] : maxDistance + 1;
            var distanceViaRetain = (newIndex > 0) && (oldIndex > 0) ? editDistanceMatrix[newIndex - 1][oldIndex - 1] : maxDistance + 1;
            if ((distanceViaAdd === undefined) || (distanceViaAdd < me - 1)) distanceViaAdd = maxDistance + 1;
            if ((distanceVadelete === undefined) || (distanceVadelete < me - 1)) distanceVadelete = maxDistance + 1;
            if (distanceViaRetain < me - 1) distanceViaRetain = maxDistance + 1;

            if ((distanceViaAdd <= distanceVadelete) && (distanceViaAdd < distanceViaRetain)) {
                editScript.push({ status: "added", value: newArray[newIndex - 1] });
                newIndex--;
            } else if ((distanceVadelete < distanceViaAdd) && (distanceVadelete < distanceViaRetain)) {
